...
#' in presidency_name_table (e.g., presidency_year, presidency_short, etc.)
#'
...
#' def_labeled <- relabel_pres_admin(def, presidency_short)
#' def_labeled <- relabel_pres_admin(def, presidency_full, keep_original = FALSE)
